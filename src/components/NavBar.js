      ...
      <div className="navRoot">
        <AppBar position="static" className={classes.navColors}>
          <Toolbar>
            ...
            <NavLink to="/add-ticket" className={classes.buttonColor}>
              <Typography variant="h6" className={classes.navTitle} to="/add-ticket">
                <Button color="inherit" className={classes.buttonColor}>
                  New Ticket
                </Button>
              </Typography>
            ...
            <Typography variant="h6" className={classes.navTitle} to="/">
              <Button color="inherit" className={classes.buttonColor} onClick={Logout}>
                Logout
              </Button>
            </Typography>
          </Toolbar>
