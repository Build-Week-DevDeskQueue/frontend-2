...
const LandingPage = props => {
  ...
  const updateTicket = (e, ticket) => {
    ...
    axiosWithAuth()
      .put(
        `https://devdesk-backend.herokuapp.com/api/tickets/${ticket.id}`,
        ticket
      )
      .then(result => {
        //fetchTickets();
  ...
  return (
    <>
      ...
      <div className="logo">
        <img src={dev_desk_logo} height="150px" width="400px" />
      </div>
      ...
      <br />
      <h4>
        Add, Save, or Delete from Tickets from Your Database. Admins may log in
        and Update Your Ticket once Received.
      </h4>
      <Route
        exact
        path="/"
      ...
      <Route
        path="/tickets/:id"
        render={props => {
          return <Ticket {...props} deleteTicket={deleteTicket} />;
        }}
      />
      <Route
      ...
      <Route
        path="/add-ticket"
        render={props => {
          return <AddTicketForm {...props} addTicket={addTicket} />;
        }}
      />
      <Issue />
      <h4>Logout </h4>
